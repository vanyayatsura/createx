<template>
  <div v-bind:class="{'scrol-blok': showModal}" class="wrapper-page">
    <div class="top-bar">
    <div class="content-wrap top-bar_wrap">
      ...
      <div  @click="openCloseMenu" id="menuBody" class="top-bar_manu-body">
        ...
        <div class="btn btn-gradient">Get consultation</div>
      </div>
      <div class="r-side">
        <a href="#" class="top-bar_login">
          <div class="icon-login"></div>
          <div @click="showModal = !showModal" class="text-login">
            <i class="fa-regular fa-user"></i>
            Log in / Register
          </div>
        </a>
        <div id="iconMenu" @click="openCloseMenu" class="icon-menu-burger"><span></span></div>
      </div>
    </div>
  </div>
  <router-view/>
  <footer class="footer">
      <div class="footer__wrap content-wrap">
        <div class="footer__createx">
          <div class="footer-logo top-bar_logo">
            <img src="../src/img/footer/footer-logo.svg" alt="logo">
          </div>
        ...
        <div class="footer__nav">
          <div class="footer-nav__cont">
            <h3 class="footer-nav__title">site map</h3>
            <ul class="footer-nav__items">
              <li class="footer-nav__item"><a href="#">About Us</a></li>
              <li class="footer-nav__item"><a href="#">Courses</a></li>
              <li class="footer-nav__item"><a href="#">Events</a></li>
              <li class="footer-nav__item"><a href="#">Blog</a></li>
              <li class="footer-nav__item"><a href="#">Contacts</a></li>
            </ul>
          </div>
          <div class="footer-nav__cont">
            <h3 class="footer-nav__title">courses</h3>
            <ul class="footer-nav__items">
              <li class="footer-nav__item"><a href="#">Marketing</a></li>
              <li class="footer-nav__item"><a href="#">Management</a></li>
              <li class="footer-nav__item"><a href="#">HR & Recruting</a></li>
              <li class="footer-nav__item"><a href="#">Design</a></li>
              <li class="footer-nav__item"><a href="#">Development</a></li>
            </ul>
          </div>
          <div class="footer-nav__cont">
            <h3 class="footer-nav__title">contact us</h3>
            <ul class="footer-nav__items">
              <li class="footer-nav__item"><a  href="tel:+384055550128">(405) 555-0128</a></li>
              <li class="footer-nav__item"><a href="mailto:hello@createx.com">hello@createx.com</a></li>
            </ul>
          </div>
        </div>
        <div class="footer__sing-up">
          <h3 class="sing-up__title subtitle">sing up to our newsletter</h3>
          <div class="footer-form">
            <input class="sing-up-input" type="text"      placeholder="Email address">
            <input class="footer__submit" type="submit" value="&#8594;">
          </div>
          <p class="sing-up__text">*Subscribe to our newsletter to receive communications and early updates from Createx SEO Agency.</p>
        </div>
        </div>
        <div class="footer__bottom">
          <div class="footer-bottom__wrap">
            <div class="copyright">© All rights reserved.</div>
            <div class="bottom__text">Made with <span>&#9825;</span> by Createx Studio </div>
            <div @click="scrollTop" class="go-top">GO TO TOP</div>
          </div>
      </div>
    </footer>
    <ShowSing v-bind:class="{overflow: showModal}"  @close="closeSing" class="modal-sing" v-show="showModal"></ShowSing>
  </div>
  ...
  <script>
    import ShowSing from './components/ShowSing.vue'
    export default {
      name: "App",
      data() {
        return{
      ...
      methods: {
        ...
        openCloseMenu: function openClose() {
